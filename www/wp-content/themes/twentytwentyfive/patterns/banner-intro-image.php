...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
    ...
    ); ?>/assets/images/botany-flowers.webp" alt="<?php echo esc_attr_x(
	"Picture of a flower",
	"Alt text for intro picture.",
	"twentytwentyfive"
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:heading -->
			<h2 class="wp-block-heading"><?php echo esc_html_x(
   	"New arrivals",
   	"Heading for banner pattern.",
   	"twentytwentyfive"
   ); ?></h2>
			<!-- /wp:heading -->
   	...
   	"Sample description for banner with flower.",
   	"twentytwentyfive"
   ); ?></p>
			<!-- /wp:paragraph -->
