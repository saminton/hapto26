...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading alignfull has-text-align-left has-xx-large-font-size"><?php esc_html_e(
  	...
  	"twentytwentyfive"
		...
		<div class="wp-block-group alignwide" style="border-top-color:var(--wp--preset--color--accent-4);border-top-width:1px;margin-top:var(--wp--preset--spacing--50);padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
			...
			<div class="wp-block-group">
				...
				<h3 class="wp-block-heading has-medium-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e(
    	"Social media",
    	"twentytwentyfive"
    ); ?></h3>
				<!-- /wp:heading -->
				<!-- wp:navigation {"overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"fontSize":"medium","layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e(
    	"Social media",
    	"twentytwentyfive"
    ); ?>"} -->
					<!-- wp:navigation-link {"label":"<?php echo esc_html_x(
     	"X",
     	"Refers to the social media platform formerly known as Twitter.",
     	"twentytwentyfive"
     ); ?>","url":"#"} /-->
					<!-- wp:navigation-link {"label":"<?php esc_html_e(
     	"Instagram",
     	"twentytwentyfive"
     ); ?>","url":"#"} /-->
					<!-- wp:navigation-link {"label":"<?php esc_html_e(
    	...
    	"twentytwentyfive"
				...
				<p class="has-medium-font-size"><?php esc_html_e(
    	"example@example.com",
    	"twentytwentyfive"
    ); ?></p>
				<!-- /wp:paragraph -->
