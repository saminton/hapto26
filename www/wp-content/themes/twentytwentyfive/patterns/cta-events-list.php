		...
		<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"level":3} -->
					<h3 class="wp-block-heading"><?php esc_html_e(
     	"Tell your story",
     	"twentytwentyfive"
     ); ?></h3>
					<!-- /wp:heading -->
				...
				<div class="wp-block-group">
					...
					<p style="text-transform:uppercase"><?php echo esc_html_x(
     	"Mon, Jan 1",
     	...
     	"twentytwentyfive"
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link wp-element-button"><?php esc_html_e(
      	"Buy Tickets",
      	"twentytwentyfive"
      ); ?></a></div>
						<!-- /wp:button -->
