...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading" style="font-size:9.6rem;letter-spacing:-0.02em"><?php esc_html_e(
  	"Our online store.",
  	"twentytwentyfive"
  ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group">
			...
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url(
   	get_template_directory_uri() . "/assets/images/grid-flower-2.webp"
   ); ?>" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
    	...
    	"twentytwentyfive"
			...
			<!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url(
   	get_template_directory_uri() . "/assets/images/malibu-plantlife.webp"
   ); ?>" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
      	...
      	'<br /><span style="font-size:2.63rem;">' .
			...
			<!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url(
   	get_template_directory_uri() . "/assets/images/akaka-falls-state-park-flora.webp"
   ); ?>" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
    	...
    	"twentytwentyfive"
			...
			<!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url(
   	get_template_directory_uri() . "/assets/images/botany-flowers.webp"
   ); ?>" alt="<?php esc_attr_e(
	"Botany flowers",
	"twentytwentyfive"
); ?>" style="aspect-ratio:1;object-fit:cover"/></figure>
			...
			<!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url(
   	get_template_directory_uri() . "/assets/images/star-thristle-flower.webp"
   ); ?>" alt="<?php esc_attr_e(
	"Black and white flower",
	"twentytwentyfive"
); ?>" style="aspect-ratio:1;object-fit:cover"/></figure>
		...
		<div class="wp-block-buttons">
			<!-- wp:button {"width":100} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button"><?php esc_html_e(
   	"Shop now",
   	"twentytwentyfive"
   ); ?></a></div>
			<!-- /wp:button -->
