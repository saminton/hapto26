...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-columns alignwide" style="padding-top:0;padding-bottom:0">
   	...
   	get_template_directory_uri() . "/assets/images/ruins-image.webp"
   ); ?>" alt="<?php esc_attr_e("Event image", "twentytwentyfive"); ?>"/></figure>
			<!-- /wp:image -->
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30)">
				...
				<h3 class="wp-block-heading" style="padding-top:var(--wp--preset--spacing--20)"><?php esc_html_e(
    	"Tell your story",
    	"twentytwentyfive"
    ); ?></h3>
				<!-- /wp:heading -->
				...
				<p class="has-accent-4-color has-text-color has-link-color has-medium-font-size"><?php echo esc_html_x(
    	"Mon, Jan 1",
    	...
    	"twentytwentyfive"
			...
			<p style="padding-top:var(--wp--preset--spacing--40)"><a href="#"><?php esc_html_e(
   	"Event details",
   	"twentytwentyfive"
   ); ?></a></p>
			<!-- /wp:paragraph -->
