...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-xx-large-font-size"><?php esc_html_e(
  	"Agenda",
  	"twentytwentyfive"
  ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--accent-6);border-top-width:1px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40%">
					<!-- wp:heading {"level":3} -->
					<h3 class="wp-block-heading"><?php echo esc_html_x(
     	"Mon, Jan 1",
       ...
       ); ?>/assets/images/marshland-birds-square.webp" alt="<?php esc_attr_e(
	"Birds on a lake.",
	"twentytwentyfive"
						...
						<div class="wp-block-column" style="flex-basis:66.66%">
							...
							<div class="wp-block-group">
								...
								<div class="wp-block-group">
									<!-- wp:heading {"level":4} -->
									<h4 class="wp-block-heading"><a href="#"><?php esc_html_e(
         	...
         	"twentytwentyfive"
								...
								<p class="has-small-font-size"><?php echo wp_kses_post(
        	_x(
        		'Lecture by <a href="#">Prof. Fiona Presley</a>',
        		"Pattern placeholder text with link.",
        		"twentytwentyfive"
        	)
        ); ?></p>
								<!-- /wp:paragraph -->
					...
					<div class="wp-block-columns is-not-stacked-on-mobile" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40)">
						...
						<div class="wp-block-column" style="flex-basis:33.33%">
							...
							<figure class="wp-block-image size-full"><img src="<?php echo esc_url(
       	get_template_directory_uri()
       ); ?>/assets/images/coral-square.webp" alt="<?php esc_attr_e(
				...
				<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:60%">
					...
					<div class="wp-block-columns is-not-stacked-on-mobile" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40)">
						...
						<div class="wp-block-column" style="flex-basis:33.33%">
							...
							<figure class="wp-block-image size-full"><img src="<?php echo esc_url(
       	get_template_directory_uri()
       ); ?>/assets/images/parthenon-square.webp" alt="<?php esc_attr_e(
        		...
        		"twentytwentyfive"
					...
					<div class="wp-block-columns is-not-stacked-on-mobile" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40)">
						...
						<div class="wp-block-column" style="flex-basis:33.33%">
							...
							<figure class="wp-block-image size-full"><img src="<?php echo esc_url(
       	get_template_directory_uri()
       ); ?>/assets/images/agenda-img-4.webp" alt="<?php esc_attr_e(
	"Black and white photo of an African woman.",
	"twentytwentyfive"
); ?>" style="aspect-ratio:1;object-fit:cover"/></figure>
							<!-- /wp:image -->
						</div>
