...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0">
   ...
   ); ?>/assets/images/book-image-landing.webp","dimRatio":0,"customOverlayColor":"#6b6b6b","isUserOverlayColor":true,"isDark":false,"style":{"dimensions":{"aspectRatio":"1"}},"layout":{"type":"default"}} -->
	...
	get_template_directory_uri()
); ?>/assets/images/book-image-landing.webp" data-object-fit="cover"/>
...
<!-- wp:heading -->
<h2 class="wp-block-heading has-xx-large-font-size"><?php echo esc_html_x(
	"The Stories Book",
...
<p class="has-medium-font-size"><?php echo esc_html_x(
	"Available for pre-order now.",
	"CTA text of the hero section.",
	"twentytwentyfive"
); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
