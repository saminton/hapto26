...
<div class="wp-block-group alignfull is-style-section-1" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-columns alignwide">
				...
				<div class="wp-block-group" style="min-height:100%">
					...
					<div class="wp-block-group">
						...
						<h2 class="wp-block-heading has-xx-large-font-size">
							<?php echo esc_html_x(
       	"The Stories Book",
       	"Hero - Overlapped book cover pattern headline text",
       	"twentytwentyfive"
       ); ?>
						</h2>
						<!-- /wp:heading -->
       	...
       	"Hero - Overlapped book cover pattern subline text",
       	"twentytwentyfive"
       ); ?>
						</p>
						<!-- /wp:paragraph -->
					...
					<div class="wp-block-group">
						...
						<p class="has-medium-font-size"><?php echo wp_kses_post(
      	_x(
     ...
     ); ?>/assets/images/book-image.webp" alt="<?php echo esc_attr__(
	"Book Image",
	"twentytwentyfive"
