...
<div class="wp-block-group alignfull is-style-section-2" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
    ...
    ); ?>/assets/images/hero-podcast.webp" alt="<?php echo esc_attr_x(
	"Picture of a person",
	...
	"twentytwentyfive"
   	...
   	"twentytwentyfive"
			...
			<div class="wp-block-group">
				...
				<h3 class="wp-block-heading has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:1px;text-transform:uppercase"><?php esc_html_e(
    	...
    	"twentytwentyfive"
				...
				<div class="wp-block-group">
					...
					<p class="is-style-text-annotation"><a href="#"><?php echo esc_html_x(
     	"YouTube",
     	"Button text",
     	"twentytwentyfive"
     ); ?></a></p>
