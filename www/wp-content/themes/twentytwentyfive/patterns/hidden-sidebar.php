...
<h2 class="wp-block-heading has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:1.6px;text-transform:uppercase"><?php esc_html_e(
	"Other Posts",
	"twentytwentyfive"
); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-query">
	...
	<!-- wp:query-no-results -->
		<!-- wp:paragraph {"placeholder":"<?php esc_attr_e(
