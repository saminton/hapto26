...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group is-style-section-3" style="min-height:297px">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e(
    	"Instagram",
    	"twentytwentyfive"
    ); ?></h2>
				<!-- /wp:heading -->
				...
				<p class="has-text-align-center has-medium-font-size"><a href="#"><?php echo esc_html_x(
    	"@example",
    	"Example username for social media account.",
    	"twentytwentyfive"
    ); ?></a></p>
				<!-- /wp:paragraph -->
				</div>
  ...
  ); ?>/assets/images/flower-meadow-square.webp" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
		...
		<figure class="wp-block-image size-full"><img src="<?php echo esc_url(
  	get_template_directory_uri()
  ); ?>/assets/images/vash-gon-square.webp" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
		...
		<figure class="wp-block-image size-full"><img src="<?php echo esc_url(
  	get_template_directory_uri()
  ); ?>/assets/images/dallas-creek-square.webp" alt="<?php esc_attr_e(
