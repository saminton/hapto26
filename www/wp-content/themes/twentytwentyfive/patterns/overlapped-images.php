...
<div class="wp-block-group alignfull is-style-section-1" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
   ...
   ); ?>/assets/images/red-hibiscus-closeup.webp" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
			...
			<div class="wp-block-group" style="margin-top:-12vw">
				...
				<figure class="wp-block-image alignright size-full is-resized" style="margin-right:-5vw;margin-left:-5vw"><img src="<?php echo esc_url(
    	get_template_directory_uri()
    ); ?>/assets/images/grid-flower-2.webp" alt="<?php esc_attr_e(
	"Black and white photography close up of a flower.",
	"twentytwentyfive"
); ?>" style="width:202px"/></figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column is-vertically-aligned-center" style="padding-right:0;padding-left:0;flex-basis:50%">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading is-style-text-annotation"><?php esc_html_e(
    	"About Us",
    	"twentytwentyfive"
    ); ?></h2>
				<!-- /wp:heading -->
   	...
   	esc_html__(
   		"%s is a flower delivery and subscription business. Based in the EU, our mission is not only to deliver stunning flower arrangements across but also foster knowledge and enthusiasm on the beautiful gift of nature: flowers.",
   		"twentytwentyfive"
   	),
   	"<strong>" .
