...
<div class="wp-block-cover alignfull is-light has-contrast-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis:65%">
				...
				<div class="wp-block-group">
					...
					<h2 class="wp-block-heading has-text-align-left" style="font-size:22rem;font-style:normal;font-weight:300;letter-spacing:-0.03em;line-height:1.4"><?php echo esc_html_x(
     	"Hey,",
     	"Example heading in pattern.",
     	"twentytwentyfive"
     ); ?></h2>
					<!-- /wp:heading -->
					<!-- wp:paragraph {"className":"is-style-text-subtitle"} -->
					<p class="is-style-text-subtitle"><?php echo esc_html_x(
     ...
     ); ?>/assets/images/woman-splashing-water.webp" alt="<?php esc_attr_e(
	...
	"twentytwentyfive"
					...
					<p class="has-text-align-right has-x-large-font-size" style="line-height:1.2"><a href="#"><?php esc_html_e(
     	"Instagram",
     	"twentytwentyfive"
     ); ?></a><br><a href="#"><?php esc_html_e(
	"LinkedIn",
	"twentytwentyfive"
); ?></a><br><a href="#"><?php echo esc_html_x(
	"Now",
	"Link to a page with information about what the person is working on right now.",
	"twentytwentyfive"
); ?></a></p>
					<!-- /wp:paragraph -->
				</div>
