...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<h2 class="wp-block-heading alignwide"><?php esc_html_e(
 	"Our services",
 	"twentytwentyfive"
 ); ?></h2>
	<!-- /wp:heading -->
    ...
    ); ?>/assets/images/campanula-alliariifolia-flower.webp" alt="<?php esc_attr_e(
	"Image for service",
	"twentytwentyfive"
   	...
   	"twentytwentyfive"
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full" style="margin-bottom:24px">
				<img src="<?php echo esc_url(
    	get_template_directory_uri()
    ); ?>/assets/images/delphinium-flowers.webp" alt="<?php esc_attr_e(
	"Image for service",
	"twentytwentyfive"
); ?>" style="aspect-ratio:4/3;object-fit:cover"/>
			</figure>
   	...
   	"twentytwentyfive"
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full" style="margin-bottom:24px">
				<img src="<?php echo esc_url(
    	get_template_directory_uri()
    ); ?>/assets/images/star-thristle-flower.webp" alt="<?php esc_attr_e(
	"Image for service",
	"twentytwentyfive"
); ?>" style="aspect-ratio:4/3;object-fit:cover"/>
			</figure>
