...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group">
		...
		<h1 class="wp-block-heading has-text-align-center is-style-text-annotation"><?php esc_html_e(
  	"Stories",
  	"twentytwentyfive"
  ); ?></h1>
		<!-- /wp:heading -->
	...
	<h2 class="wp-block-heading alignwide has-text-align-center has-xx-large-font-size"><?php esc_html_e(
 	"Tell your story",
 	"twentytwentyfive"
 ); ?></h2>
	<!-- /wp:heading -->
