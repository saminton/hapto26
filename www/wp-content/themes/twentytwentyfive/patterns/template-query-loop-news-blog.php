...
<div class="wp-block-group">
	...
	<p class="has-accent-4-color has-text-color has-link-color has-small-font-size"><?php echo esc_html_x(
 	"Written by",
...
<!-- wp:query-pagination-previous {"label":"<?php esc_html_e(
	"Newer Posts",
	"twentytwentyfive"
); ?>"} /-->
...
<!-- wp:query-pagination-next {"label":"<?php esc_html_e(
	"Older Posts",
	"twentytwentyfive"
); ?>"} /-->
