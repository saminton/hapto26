...
<!-- wp:template-part {"slug":"header-large-title"} /-->
	...
	<main class="wp-block-group alignwide">
		...
		<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
       	...
       	"by",
       	"Prefix before the author name. The post author name is displayed in a separate block.",
       	"twentytwentyfive"
       ); ?></p>
							<!-- /wp:paragraph -->
    	...
    	"Post navigation",
    	"twentytwentyfive"
    ); ?>","tagName":"nav","align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
