...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group">
						...
						<div class="wp-block-group has-small-font-size">
							<!-- wp:paragraph --><p><?php echo esc_html_x(
       	"Published on",
       	"Prefix before the post date block.",
       	"twentytwentyfive"
       ); ?></p><!-- /wp:paragraph -->
						...
						<div class="wp-block-group has-small-font-size">
							<!-- wp:paragraph --><p><?php echo esc_html_x(
       	"Posted by",
       	"Prefix before the author name. The post author name is displayed in a separate block on the next line.",
       	"twentytwentyfive"
       ); ?></p><!-- /wp:paragraph -->
					...
					<div class="wp-block-group">
						...
						<div class="wp-block-group">
							...
							<p class="has-small-font-size"><?php echo esc_html_x(
       	"Categories:",
       	"Prefix before one or more categories. The categories are displayed in a separate block on the next line.",
       	"twentytwentyfive"
       ); ?></p>
							<!-- /wp:paragraph -->
						...
						<div class="wp-block-group">
							...
							<p class="has-small-font-size"><?php echo esc_html_x(
       	"Tagged:",
       	"Prefix before one or more tags. The tags are displayed in a separate block on the next line.",
       	"twentytwentyfive"
       ); ?></p>
							<!-- /wp:paragraph -->
		...
		<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:0">
			<!-- wp:group {"ariaLabel":"<?php esc_attr_e(
   	"Post navigation",
   	"twentytwentyfive"
   ); ?>","tagName":"nav","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
			<nav aria-label="<?php esc_attr_e(
   	"Post navigation",
   	"twentytwentyfive"
   ); ?>" class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
				<!-- wp:post-navigation-link {"type":"previous","label":"<?php esc_html_e(
    	"Previous Photo",
    	"twentytwentyfive"
    ); ?>","fontSize":"small"} /-->
				<!-- wp:post-navigation-link {"label":"<?php esc_html_e(
    	"Next Photo",
    	"twentytwentyfive"
    ); ?>","fontSize":"small"} /-->
			</nav>
